...
% Source: converted_markdown/implementation.md
...
\begin{figure}[ht]
\begin{center}
  \includegraphics*[width=\textwidth]{../Toward_an_Executable_ESG_Aspect_Based_Sentiment_Analysis_Framework_for_Indonesian_Sustainability_Reports__1_/Figures/03_01_overview}
\end{center}
...
\begin{figure}[ht]
\begin{center}
  \includegraphics*[width=\textwidth]{../Toward_an_Executable_ESG_Aspect_Based_Sentiment_Analysis_Framework_for_Indonesian_Sustainability_Reports__1_/Figures/03_01_01_system_architecture}
\end{center}
...
\begin{figure}[ht]
\begin{center}
  \includegraphics*[width=\textwidth]{../Toward_an_Executable_ESG_Aspect_Based_Sentiment_Analysis_Framework_for_Indonesian_Sustainability_Reports__1_/Figures/03_02_data_sources}
\end{center}
...
\begin{figure}[ht]
\begin{center}
  \includegraphics*[width=\textwidth]{../Toward_an_Executable_ESG_Aspect_Based_Sentiment_Analysis_Framework_for_Indonesian_Sustainability_Reports__1_/Figures/03_02_02}
\end{center}
...
\begin{figure}[ht]
\begin{center}
  \includegraphics*[width=\textwidth]{../Toward_an_Executable_ESG_Aspect_Based_Sentiment_Analysis_Framework_for_Indonesian_Sustainability_Reports__1_/Figures/03_04}
\end{center}
...
Formally, if a sentence \textbackslash\{\}(x\textbackslash\{\}) is transformed into a sparse vector \textbackslash\{\}(v(x)\textbackslash\{\}), the linear classifier computes scores of the form

\textbackslash\{\}[ z\_k = w\_k^ v(x) + b\_k \textbackslash\{\}]
...
The hybrid model then fuses four information sources: sentence vectors, contextual section vectors, ontology vectors, and a document vector. In the class, the fused representation is formed by concatenation followed by a nonlinear projection:

\textbackslash\{\}[ h\_i = f([s\_i ; c\_i ; o\_i ; d]) \textbackslash\{\}]

where \textbackslash\{\}(s\_i\textbackslash\{\}) is the sentence vector, \textbackslash\{\}(c\_i\textbackslash\{\}) is the contextual section vector, \textbackslash\{\}(o\_i\textbackslash\{\}) is the ontology vector, \textbackslash\{\}(d\textbackslash\{\}) is the document-level vector, and \textbackslash\{\}(f()\textbackslash\{\}) is the learned fusion network. Separate output heads then predict sentiment and tone. This representation is appropriate because ESG disclosure meaning is often shaped by both local phrasing and broader section context, for example when a metric appears inside a target-setting section or a governance compliance section.
...
\begin{figure}[ht]
\begin{center}
  \includegraphics*[width=\textwidth]{../Toward_an_Executable_ESG_Aspect_Based_Sentiment_Analysis_Framework_for_Indonesian_Sustainability_Reports__1_/Figures/03_05}
\end{center}
...
At a high level, the framework processes a batch \textbackslash\{\}(B = \textbackslash\{\}\{p\_1, , p\_n\textbackslash\{\}\}\textbackslash\{\}) of page texts under prompt template \textbackslash\{\}(q\textbackslash\{\}) and model \textbackslash\{\}(m\textbackslash\{\}) to produce a structured output set \textbackslash\{\}(R\textbackslash\{\}):

\textbackslash\{\}[ R = F(B, q, m) \textbackslash\{\}]
...
\begin{figure}[ht]
\begin{center}
  \includegraphics*[width=\textwidth]{../Toward_an_Executable_ESG_Aspect_Based_Sentiment_Analysis_Framework_for_Indonesian_Sustainability_Reports__1_/Figures/03_06}
\end{center}
...
\begin{figure}[ht]
\begin{center}
  \includegraphics*[width=\textwidth]{../Toward_an_Executable_ESG_Aspect_Based_Sentiment_Analysis_Framework_for_Indonesian_Sustainability_Reports__1_/Figures/03_07_summary}
\end{center}
