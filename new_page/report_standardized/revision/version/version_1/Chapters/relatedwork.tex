...
\begin{table}[p]
\centering
\caption{State-of-the-art research on NLP-driven ESG extraction and greenwashing analysis.}
\label{tab:relatedwork-esg-greenwashing-overview-a}
\small
...
\begin{table}[p]
\centering
\caption{Complementary studies on NLP-driven ESG analysis, target assessment, and model sensitivity.}
\label{tab:relatedwork-esg-greenwashing-overview-b}
\small
\renewcommand{\arraystretch}{1.2}
\begin{tabularx}{\linewidth}{|p{1.8cm}|X|X|p{1.8cm}|X|X|}
\hline
...
\begin{table}[p]
\centering
\caption{State-of-the-art milestones in the evolution of NLP for sustainability analysis.}
\label{tab:relatedwork-nlp-evolution-a}
\small
\renewcommand{\arraystretch}{1.2}
...
\begin{table}[p]
\centering
\caption{Research on hallucination risk, grounding, and validation in ESG-oriented LLM workflows.}
\label{tab:relatedwork-hallucination-grounding-a}
\small
\renewcommand{\arraystretch}{1.2}
...
\begin{table}[p]
\centering
\caption{Additional benchmark-oriented studies on target assessment, external validation, and deception-sensitive ESG extraction.}
\label{tab:relatedwork-hallucination-grounding-b}
\small
\renewcommand{\arraystretch}{1.2}
...
\begin{table}[p]
\centering
\caption{Additional benchmark designs for selective reporting, transparency gaps, and deception-oriented ESG evaluation.}
\label{tab:relatedwork-esg-benchmark-design-b}
\small
\renewcommand{\arraystretch}{1.2}
