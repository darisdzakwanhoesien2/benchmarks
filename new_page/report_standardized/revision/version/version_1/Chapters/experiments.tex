...
\end{center}
\caption{Tone distribution across the active extracted-record layer. This figure supports RQ1 by showing that the schema yields a usable tone distribution in the current thesis-facing subset, with commitment as the dominant class.}
...
\end{center}
\caption{Aspect-by-tone heatmap for the active extracted-record layer. This figure supports RQ1 by showing which aspects are concentrated in commitment, action, or outcome language rather than only reporting overall counts.}
...
\end{center}
\caption{Cross-distribution of LLM tone labels and ClimateBERT-style labels. This figure supports RQ2 by showing where commitment aligns strongly and where action or outcome labels diverge from climate-topic categorization.}
