...
% \subsection{RQ3 and RQ4: ClimateBERT Comparison, Diagnostics, and Failure Modes}

% The most important quantitative comparison result is the alignment between disclosure tone and ClimateBERT-style commitment labels. Table 10 summarizes the main agreement result.

% \begin{table}[htbp]
% \centering
% \caption{Prompt-level extraction performance}
% \label{tab:prompt-extraction-performance}
...
%     *{5}{>{\centering\arraybackslash}p{0.10\linewidth}}
% }
% \toprule
% \textbf{Prompt}
% &
...
% \texttt{Tone commitment vs climate-commitment label}
...
% \hline
% \textbf{Tone} & \textbf{Ambiguous Actions} & \textbf{Brown Projects} & \textbf{Misinformation} & \textbf{no} & \textbf{yes} \\ \hline
% commitment & 12 & 860 & 6 & 61 & 54 \\ \hline
% action & 25 & 1391 & 37 & 56 & 2 \\ \hline
% outcome & 12 & 926 & 35 & 44 & 6 \\ \hline
% missing & 16 & 1710 & 82 & 78 & 31 \\ \hline
% \end{tabular}
% \end{table}
...
% \begin{tabular}{|c|c|c|}
% \hline
% \textbf{Failure Mode} & \textbf{Tone Predicted} & \textbf{Count} \\ \hline
% missing\_tone & missing & 61 \\ \hline
% schema\_drift & missing & 19 \\ \hline
% hedged\_or\_modal\_language & missing & 9 \\ \hline
% regulatory\_or\_indonesian\_domain\_terms & missing & 3 \\ \hline
% table\_or\_numeric\_layout & missing & 3 \\ \hline
% passive\_voice & missing & 2 \\ \hline
% bilingual\_or\_code\_switched & action & 1 \\ \hline
% hedged\_or\_modal\_language & action & 1 \\ \hline
% passive\_voice & action & 1 \\ \hline
% schema\_drift & action & 1 \\ \hline
% \end{tabular}
% \end{table}
...
% These findings reveal an important contradiction. The system is semantically organized enough to map diverse ESG aspects to ontology paths, yet it is still fragile when asked to consistently distinguish commitment, action, and outcome in noisy or governance-heavy contexts. That contradiction becomes one of the central interpretive findings of the chapter.
% \subsection{RQ5 and RQ6: Reproducibility, Visualization, and Stability}
...
% \label{tab:model-extraction-performance}
...
% Commitment example: “As a pioneer among industrial estate developers in Indonesia, BeFa is at the forefront of creating a green and eco-friendly industrial zone...” This record is labeled commitment, carries environmental claims, and receives a strong local climate-commitment prediction.\item 

% Outcome example: “Keberhasilan pembangunan fasilitas perakitan kendaraan listrik di Magelang menjadi tonggak penting...” This record is labeled outcome with positive sentiment because it describes a realized infrastructure milestone.\item 
...
% These examples show that the tone taxonomy is meaningful in practice. The main challenge is not whether the categories are interpretable, but whether the extraction layer can assign them consistently across different prompts, models, and disclosure styles.
% \section{Validation of Reference Data and Pseudo-Ground Truth}
...
% Overall, the selected reference system is reliable enough for exploratory evaluation, disagreement analysis, and chapter-level empirical claims about patterns and failure modes. It is not yet reliable enough for definitive benchmark claims about absolute model superiority.
% \section{Comparative Component Analysis and Ablation-Like Findings}
