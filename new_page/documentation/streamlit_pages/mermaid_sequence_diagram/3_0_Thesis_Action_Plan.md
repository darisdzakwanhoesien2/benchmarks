...
- Filename: `3_0_Thesis_Action_Plan.py`
- Source path: `pages/3_0_Thesis_Action_Plan.py`
- Diagram file: `documentation/streamlit_pages/mermaid_sequence_diagram/3_0_Thesis_Action_Plan.md`
- Page slug: `3_0_Thesis_Action_Plan`
- Category: `thesis`
...
This file documents the interaction flow for `3_0_Thesis_Action_Plan.py` and gives a reusable filename pattern for the artifacts that this page reads or writes.
...
sequenceDiagram
    ...
    participant page as 3_0_Thesis_Action_Plan.py
    ...
    Note over page: pages/3_0_Thesis_Action_Plan.py
