...
This file documents the interaction flow for `5_Thesis_Systematic_Workflow_dashboard.py` and gives a reusable filename pattern for the artifacts that this page reads or writes.
