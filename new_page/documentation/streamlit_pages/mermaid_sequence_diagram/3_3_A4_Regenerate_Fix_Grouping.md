...
This file documents the interaction flow for `3_3_A4_Regenerate_Fix_Grouping.py` and gives a reusable filename pattern for the artifacts that this page reads or writes.
