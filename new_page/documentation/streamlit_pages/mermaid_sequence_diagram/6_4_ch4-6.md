# Ch4-6 Benchmarks + DOCX Graphs

- Filename: `6_4_ch4-6.py`
- Source path: `pages/6_4_ch4-6.py`
- Diagram file: `documentation/streamlit_pages/mermaid_sequence_diagram/6_4_ch4-6.md`
- Page slug: `6_4_ch4-6`
- Category: `thesis`
...
This file documents the interaction flow for `6_4_ch4-6.py` and gives a reusable filename pattern for the artifacts that this page reads or writes.
...
sequenceDiagram
    ...
    participant page as 6_4_ch4-6.py
    ...
    Note over page: pages/6_4_ch4-6.py
