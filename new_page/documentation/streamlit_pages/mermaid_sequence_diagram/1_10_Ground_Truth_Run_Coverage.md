...
This file documents the interaction flow for `1_10_Ground_Truth_Run_Coverage.py` and gives a reusable filename pattern for the artifacts that this page reads or writes.
