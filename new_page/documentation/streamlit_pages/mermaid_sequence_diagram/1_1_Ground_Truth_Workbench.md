...
This file documents the interaction flow for `1_1_Ground_Truth_Workbench.py` and gives a reusable filename pattern for the artifacts that this page reads or writes.
