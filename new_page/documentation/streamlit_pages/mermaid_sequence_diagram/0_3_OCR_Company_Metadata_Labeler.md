...
This file documents the interaction flow for `0_3_OCR_Company_Metadata_Labeler.py` and gives a reusable filename pattern for the artifacts that this page reads or writes.
