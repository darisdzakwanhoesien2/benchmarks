...
This file documents the interaction flow for `6_0_Thesis_Draft_Chapter_Integration_Mermaid.py` and gives a reusable filename pattern for the artifacts that this page reads or writes.
