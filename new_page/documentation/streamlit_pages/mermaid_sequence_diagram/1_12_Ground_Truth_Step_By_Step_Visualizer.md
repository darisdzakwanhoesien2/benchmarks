# Ground Truth Step-by-Step Visualizer

- Filename: `1_12_Ground_Truth_Step_By_Step_Visualizer.py`
- Source path: `pages/1_12_Ground_Truth_Step_By_Step_Visualizer.py`
- Diagram file: `documentation/streamlit_pages/mermaid_sequence_diagram/1_12_Ground_Truth_Step_By_Step_Visualizer.md`
- Page slug: `1_12_Ground_Truth_Step_By_Step_Visualizer`
...
This file documents the interaction flow for `1_12_Ground_Truth_Step_By_Step_Visualizer.py` and gives a reusable filename pattern for the artifacts that this page reads or writes.
...
sequenceDiagram
    ...
    participant page as 1_12_Ground_Truth_Step_By_Step_Visualizer.py
    ...
    Note over page: pages/1_12_Ground_Truth_Step_By_Step_Visualizer.py
