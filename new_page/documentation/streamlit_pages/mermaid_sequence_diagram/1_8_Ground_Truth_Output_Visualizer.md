...
This file documents the interaction flow for `1_8_Ground_Truth_Output_Visualizer.py` and gives a reusable filename pattern for the artifacts that this page reads or writes.
