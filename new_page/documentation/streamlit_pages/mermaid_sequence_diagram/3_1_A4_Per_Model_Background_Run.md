...
This file documents the interaction flow for `3_1_A4_Per_Model_Background_Run.py` and gives a reusable filename pattern for the artifacts that this page reads or writes.
