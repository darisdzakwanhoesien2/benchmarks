# A.4 Per-Model Dashboard

- Filename: `3_2_A4_Per_Model_Dashboard.py`
- Source path: `pages/3_2_A4_Per_Model_Dashboard.py`
- Diagram file: `documentation/streamlit_pages/mermaid_sequence_diagram/3_2_A4_Per_Model_Dashboard.md`
- Page slug: `3_2_A4_Per_Model_Dashboard`
- Category: `analysis`
...
This file documents the interaction flow for `3_2_A4_Per_Model_Dashboard.py` and gives a reusable filename pattern for the artifacts that this page reads or writes.
...
sequenceDiagram
    ...
    participant page as 3_2_A4_Per_Model_Dashboard.py
    ...
    Note over page: pages/3_2_A4_Per_Model_Dashboard.py
