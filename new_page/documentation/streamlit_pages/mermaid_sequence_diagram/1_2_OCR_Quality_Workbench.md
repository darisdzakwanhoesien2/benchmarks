# OCR Quality Workbench

- Filename: `1_2_OCR_Quality_Workbench.py`
- Source path: `pages/1_2_OCR_Quality_Workbench.py`
- Diagram file: `documentation/streamlit_pages/mermaid_sequence_diagram/1_2_OCR_Quality_Workbench.md`
- Page slug: `1_2_OCR_Quality_Workbench`
...
This file documents the interaction flow for `1_2_OCR_Quality_Workbench.py` and gives a reusable filename pattern for the artifacts that this page reads or writes.
...
sequenceDiagram
    ...
    participant page as 1_2_OCR_Quality_Workbench.py
    ...
    Note over page: pages/1_2_OCR_Quality_Workbench.py
