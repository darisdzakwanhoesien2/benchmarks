...
- Filename: `1_17_Phase_2_Resolver.py`
- Source path: `pages/1_17_Phase_2_Resolver.py`
- Diagram file: `documentation/streamlit_pages/mermaid_sequence_diagram/1_17_Phase_2_Resolver.md`
- Page slug: `1_17_Phase_2_Resolver`
- Category: `analysis`
...
This file documents the interaction flow for `1_17_Phase_2_Resolver.py` and gives a reusable filename pattern for the artifacts that this page reads or writes.
...
sequenceDiagram
    ...
    participant page as 1_17_Phase_2_Resolver.py
    ...
    Note over page: pages/1_17_Phase_2_Resolver.py
