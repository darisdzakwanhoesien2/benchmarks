...
This file documents the interaction flow for `1_4_ClimateBERT_Record_Batch.py` and gives a reusable filename pattern for the artifacts that this page reads or writes.
