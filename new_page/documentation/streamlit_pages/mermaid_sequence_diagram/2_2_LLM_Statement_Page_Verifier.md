...
This file documents the interaction flow for `2_2_LLM_Statement_Page_Verifier.py` and gives a reusable filename pattern for the artifacts that this page reads or writes.
