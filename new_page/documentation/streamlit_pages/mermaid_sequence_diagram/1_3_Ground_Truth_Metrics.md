...
This file documents the interaction flow for `1_3_Ground_Truth_Metrics.py` and gives a reusable filename pattern for the artifacts that this page reads or writes.
