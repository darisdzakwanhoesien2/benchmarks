...
- Filename: `1_6_Ontology_Path_Viewer.py`
- Source path: `pages/1_6_Ontology_Path_Viewer.py`
- Diagram file: `documentation/streamlit_pages/mermaid_sequence_diagram/1_6_Ontology_Path_Viewer.md`
- Page slug: `1_6_Ontology_Path_Viewer`
- Category: `analysis`
...
This file documents the interaction flow for `1_6_Ontology_Path_Viewer.py` and gives a reusable filename pattern for the artifacts that this page reads or writes.
...
sequenceDiagram
    ...
    participant page as 1_6_Ontology_Path_Viewer.py
    ...
    Note over page: pages/1_6_Ontology_Path_Viewer.py
