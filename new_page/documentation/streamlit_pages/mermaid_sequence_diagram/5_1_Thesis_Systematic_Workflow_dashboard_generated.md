...
This file documents the interaction flow for `5_1_Thesis_Systematic_Workflow_dashboard_generated.py` and gives a reusable filename pattern for the artifacts that this page reads or writes.
