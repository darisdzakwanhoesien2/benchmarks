...
{Executable system architecture of the repository, rewritten from the repository's Mermaid workflow documentation into a LaTeX-safe diagram.
  \ {CC
BY 4.0}.}
...
### Technical Characteristics and Sampling
...
### Ethics, Bias, and Data Limitations
...
### OCR Expansion and First-Stage Extraction
...
### Standardization, Storage, and Tooling
...
### Conversion into Structured ESG Records
...
### Classical Sparse Text Features
...
### Contextual and Hybrid Representations
...
### Ontology-Based Feature Enhancement
...
### Framework 1: LLM-Centered ESG Record Generation
...
### Framework 2: Benchmarking, Comparison, and Evidence Scoring
...
## Ground Truth, Weak Labels, and Evaluation Reference
...
### Why a Special Reference Construction Process Is Needed
...
### Validation, Constraints, and Current Limitations
