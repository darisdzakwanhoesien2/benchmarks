...
st.markdown(
    """
This page explores sentence-level distributions from an uploaded ESG dataset.

**What this page does**
- validates the uploaded file against the required ESG columns
- normalizes aspect categories against the bundled ontology
- visualizes aspect, ontology, sentiment, and tone distributions

**What this page expects**
- an uploaded CSV with `aspect`, `aspect_category`, `ontology_uri`, `sentiment`, `tone`, and `sentence`

**How to use it**
- upload a dataset from the sidebar
- confirm the preview and required columns first
- use the charts to spot class imbalance, missing mappings, and ontology drift
"""
)
