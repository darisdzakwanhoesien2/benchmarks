...
st.markdown(
    """
This page builds an upload-driven balancing workflow for tone analysis.

**What this page does**
- normalizes uploaded labels against the aspect, sentiment, and tone ontologies
- computes tone distributions for uploaded data only
- generates Sankey and balancing views without relying on the bundled project dataset

**What this page expects**
- an uploaded CSV with `aspect_category`, `sentiment`, and `tone`

**How to use it**
- upload a fresh dataset when you want ad hoc analysis
- use this page when you do not want to overwrite or depend on the bundled data files
- compare balancing decisions before exporting a sampled subset
"""
)
