...
if text_input:
    ...
    add_section_explanation("Rule-Based Model Output")
    ...
    add_section_explanation("Classical ML Output")
    ...
    add_section_explanation("Deep Model Output")
